...
public class ExpandIconView extends View {
    ...
    public ExpandIconView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            colorIntermediate = array.getColor(R.styleable.ExpandIconView_eiv_colorIntermediate, Color.WHITE);
    ...
    private void updateColor(@NonNull ArgbEvaluator colorEvaluator) {
        ...
        if (colorIntermediate != -1) {
            ...
            fraction = alpha <= 0 ? (1 + alpha / LESS_STATE_ALPHA) : alpha / LESS_STATE_ALPHA;
        } else {
            colorFrom = colorMore;
            colorTo = colorLess;
            fraction = (alpha + LESS_STATE_ALPHA) / 90f;
        }
