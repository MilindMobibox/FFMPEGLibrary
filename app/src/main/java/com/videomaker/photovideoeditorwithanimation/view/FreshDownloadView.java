...
public class FreshDownloadView extends View {
    ...
    public FreshDownloadView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        circular_edge = getResources().getDimension(R.dimen._10sdp);
    ...
    private void parseAttrs(TypedArray array) {
        if (array != null) {
            try {
                setRadius(array.getDimension(R.styleable.FreshDownloadView_circular_radius, getResources().getDimension(R.dimen._80sdp)));
                ...
                setCircularWidth(array.getDimension(R.styleable.FreshDownloadView_circular_width, getResources().getDimension(R.dimen._3sdp)));
                setProgressTextSize(array.getDimension(R.styleable.FreshDownloadView_progress_text_size, getResources().getDimension(R.dimen._50sdp)));
            } finally {
                array.recycle();
            }
        }
    ...
    static class FreshDownloadStatus extends AbsSavedState {
        ...
        float radius;
        int circular_color;
        int circular_progress_color;
        float circular_width;
        ...
        FreshDownloadStatus(Parcelable superState) {
            super(superState);
        }

        FreshDownloadStatus(Parcel in) {
            super(in);
