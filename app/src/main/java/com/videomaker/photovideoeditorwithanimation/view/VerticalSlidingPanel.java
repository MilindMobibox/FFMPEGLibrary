...
public class VerticalSlidingPanel extends ViewGroup {
    ...
    int mMinFlingVelocity = DEFAULT_MIN_FLING_VELOCITY;
    ...
    public VerticalSlidingPanel(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.above_shadow,
                        context.getTheme());
            } else {
                mShadowDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.below_shadow,
                        context.getTheme());
            }
